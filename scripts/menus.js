/* Cette fonction est responsable d'afficher le dropdown pour les tags correspondant quand la flêche vers le bas est cliquée
* Quand la flêche vers le haut est cliquée le dropdown se ferme
*/
