function getRecipeCard(data) {
    ...
    const picture = `assets/Photos/photos/Recette${id}.jpg`;
    ...
    recipeImg.setAttribute("class", "recipe_photo");
    recipeImg.setAttribute("alt", data.name);
    ...
    recipeDivImg.appendChild(recipeImg)
    recipeArticle.appendChild(recipeDivImg)
